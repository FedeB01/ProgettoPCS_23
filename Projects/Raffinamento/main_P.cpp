...
unsigned int teta1 = 144; //Triangoli da raffinare nella prima maglia triangolare
unsigned int teta2 = 186; //Triangoli da raffinare nella prima maglia triangolare
